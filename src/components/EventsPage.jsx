          ...
          <div id="eventGrid" className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-center p-5 px-5 md:px-32">
            {filteredEvents.map((event, index) => (
              ...
              >
                ...
                <button
                className="w-4/5 mx-auto bg-blue-500 border-2 border-blue-500 p-2.5 mt-2 text-center text-sm rounded cursor-pointer text-white transition transform duration-200 ease-in-out hover:scale-105"
