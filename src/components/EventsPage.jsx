...
const eventsData = [
  ...
  },
  {
    ...
    img: "https://i.ibb.co/V0xK06MS/drone.jpg",
    ...
    link: "https://docs.google.com/forms/d/e/1FAIpQLSd7OkahU6fW9jKxedYe9dxtn6_7lJA2aZQHqFRBtrYu4TAjtw/viewform?usp=preview",
    rulebook: "/rulebook-megaleio.pdf#droneDexterity",
  },
];
...
export default function EventsPage() {
  ...
  return (
    <>
      {/* Main Events Section */}
      {/* 1) Added overflow-x-hidden to avoid horizontal scrolling issues */}
      <section className="relative font-[Minecraft] min-h-[calc(100vh+150px)] bg-[#1D1C1B] min-w-screen overflow-x-hidden">
        <div>
          <br />
          {/* Page Title */}
          <div className="text-center mb-8 mt-20">
            ...
            <div>
              <p className="text-base md:text-lg max-w-2xl mx-auto">
                ...
                across different domains. Join us on 7th &amp; 8th March 2025 to
          ...
          {/* ^^^ 2) Properly closed the search container div above ^^^ */}
                    ...
                    <div className="bg-white border-2 border-blue-500 p-5 rounded-3xl text-center flex flex-col shadow-md h-full relative">
                      ...
                      <div className="flex-grow overflow-y-auto px-4">
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                          Additional details and rules can be found in the
                          rulebook.
                        </p>
                      </div>
