      ...
      <div className="container mx-auto px-6" data-aos="fade-up">
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="text-center md:text-left">
            ...
            />
            <br></br>
            <p className='font-[Minecraft-light]'>A National Level Intercollegiate Technical Event where innovation meets excellence</p>
          </div>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              <a href="https://instagram.com/megaleio2025" target="_blank" rel="noopener noreferrer"
                 className="bg-gradient-to-tr from-[#FF00A3] via-[#FF005C] to-[#FF7A00] hover:from-[#FF1CAC] hover:via-[#FF2C6D] hover:to-[#FF8B1A] text-white p-2 rounded transition-colors">
