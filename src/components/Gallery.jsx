...
export default function Gallery() {
  ...
  return (
    <div className="relative w-full pt-5 md:pt-20 z-20" data-aos="fade-up">
      {/* Title */}
      <h2
  className="text-4xl md:text-6xl font-[Minecraft] text-center text-green-500 drop-shadow-lg mb-12" 
  data-aos="zoom-in" 
